...
#ifndef SHARE_GC_RTGC_RTGCTHREADLOCALDATA_HPP
#define SHARE_GC_RTGC_RTGCTHREADLOCALDATA_HPP
...
public:
  static void create(Thread* thread) {
    new (data(thread)) RtgcThreadLocalData();
  }

  static void destroy(Thread* thread) {
    data(thread)->~RtgcThreadLocalData();
  }
...
#endif // SHARE_GC_RTGC_RTGCTHREADLOCALDATA_HPP
