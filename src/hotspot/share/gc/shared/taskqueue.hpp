...
{
public:
  ObjArrayTask(oop o = NULL, int idx = 0, bool tenure_reachable = false): _obj(o), _tenure_reachable(tenure_reachable) { }
  ObjArrayTask(oop o, size_t idx, bool tenure_reachable = false): _obj(o), _index(int(idx)), _tenure_reachable(tenure_reachable) {
  ...
  inline int tenure_reachable() const { return _tenure_reachable; }
