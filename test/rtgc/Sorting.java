...
public class Sorting {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("DUAL_PIVOT_QUICKSORT");
        // new Sorting(SortingHelper.DUAL_PIVOT_QUICKSORT, randoms, lengths).testCore();
        // System.out.println("PARALLEL_SORT");
        ...
        // System.out.println("ARRAYS_SORT");
        new Sorting(SortingHelper.ARRAYS_SORT, randoms, lengths).testAll();
        System.out.println("ARRAYS_PARALLEL_SORT");
        //showLog = true;
    ...
    private void testStability(int length, TestRandom random) {
        showLog2 = showLog;// && length >= 1000;
        printTestName("Test stability", random, length);

        System.out.println("testStability 1");
        Pair[] a = build(length, random);
        System.out.println("testStability 2");
        sortingHelper.sort(a);
        System.out.println("testStability 3");
        checkSorted(a);
        System.out.println("testStability 4");
        checkStable(a);

        System.out.println("testStability 5");
        a = build(length, random);
        System.out.println("testStability 6");
        sortingHelper.sort(a, pairComparator);
        System.out.println("testStability 7");
        checkSorted(a);
        System.out.println("testStability 8");
        checkStable(a);
    ...
    private void printTestName(String test, TestRandom random, int length, String message) {
        if (showLog && showLog2) out.println( "[" + sortingHelper + "] '" + test +
